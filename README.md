...
Это тестовый бот для воспроизведения музыки из выбранного видео с ютуб. Чтобы им воспользоваться, установите PY 3.10+, установите бибилиотеку FFmpeg, после чего в файле comfig.py установите токен своего бота, откройте файл bot.py.
